...
class replay(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "replay", catch_exceptions=True)
        ...
        self.uhd_usrp_sink_0.set_center_freq(433.92, 0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, './record.cf32', True, 0, 0)
